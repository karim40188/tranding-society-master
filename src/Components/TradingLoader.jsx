...
function TradingLoader() {
  const chartLineAnimation = {
    ...
    visible: {
      pathLength: 1,
      transition: {
        duration: 1,  // زيادة مدة الرسوم لتكون أطول
        ease: "easeInOut",
      },
    },
  };
      ...
      >
        ...
        <defs>
          <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" style={{ stopColor: "#D6AA1C", stopOpacity: 1 }} />
            <stop offset="100%" style={{ stopColor: "#5D5329", stopOpacity: 1 }} />
          </linearGradient>
        </defs>

        {/* الرسم البياني المتحرك مع منحنى صاعد وثابت */}
        <motion.path
