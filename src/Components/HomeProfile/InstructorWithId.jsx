...
function InstructorWithId() {
  ...
  let { baseUrl, darkMode } = useContext(DarkModeContext); // إضافة darkMode من الـ Context
    ...
    <Grid container justifyContent="center" sx={{ marginTop: "50px" }}>
      <Card
        sx={{
          ...
          margin: "auto",
          padding: "30px",
          boxShadow: darkMode ? "0px 4px 20px rgba(255, 255, 255, 0.1)" : "0px 4px 20px rgba(0, 0, 0, 0.1)",
          borderRadius: "20px",
