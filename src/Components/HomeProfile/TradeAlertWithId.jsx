...
function TradeAlertWithId() {
  ...
  return (
    <Card sx={{ backgroundColor: "#262626", color: "#fff", p: 2, borderRadius: "15px" }}>
      <CardContent>
        {/* Instructor Name */}
        ...
        <Typography variant="body1" sx={{ color: "#fff", mb: 1 }}>
          TP1: {offer.tp1}, TP2: {offer.tp2}, TP3: {offer.tp3}, TP4: {offer.tp4}, TP5: {offer.tp5}
        </Typography>

        {/* Chart Image */}
        <Box sx={{ mt: 2 }}>
          <img src={offer.chart_image} alt="Chart" style={{ maxWidth: "100%", borderRadius: "10px" }} />
        </Box>
